                ...
                let detail = match sym.kind {
                    ...
                    SymbolKindInfo::Method => {
                        let params: Vec<String> = sym
                            ...
                            .map(|(n, t)| format!("{} {}", format_type(t), n))
                            .collect();
                        format!("**method** `{}`\n\n```\nnee {}({}) -> {}\n```", sym.name, sym.name, params.join(", "), type_str)
                    }
